...
class MoveZoneCommand(command.Command):
    """Move a zone"""
    def get_parser(self, prog_name):
        parser = super(MoveZoneCommand, self).get_parser(prog_name)

        parser.add_argument('zone_id', help="Zone ID")
        parser.add_argument('--pool_id', help="Pool ID")
    ...
    def take_action(self, parsed_args):
        ...
        client.zones.move(parsed_args.zone_id, data)
